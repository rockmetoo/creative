<?php
	...
	class CDBQuery
	{
		...
		private $default_connection	= 'simpleso';
		...
		private $db_connections_pool = array(
			'simpleso'		=> array('simpleso', 'root', 'uselesspass', 'www_simpleso_jp', '3306', NULL),
			'simpleso_crm'	=> array('simpleso_crm', 'root', 'uselesspass', 'simpleso_crm', '3306', NULL),
		);

		public function __construct($connection = '')
		{
			include_once('includes'. DIRECTORY_SEPARATOR . 'memcache_sql_values.php');
		...
		{
			if(!$value && isset($this->registered_sql[$index])) return $this->registered_sql[$index];
