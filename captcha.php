<?php
	...
	$resourcePath = CSettings::$BASE_DIRECTORY . DIRECTORY_SEPARATOR . 'resources';
	$captcha->wordsFile = $resourcePath . DIRECTORY_SEPARATOR . 'words' . DIRECTORY_SEPARATOR . 'en.php';
	//$captcha->session_var = 'secretword';
	//$captcha->imageFormat = 'png';
	//$captcha->scale = 3; $captcha->blur = true;
	$captcha->resourcesPath = $resourcePath;
	...
	*/
	...
	class CCaptcha
	{
	    ...
	    public $backgroundColor = array(234, 234, 234);
